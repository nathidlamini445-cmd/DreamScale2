  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="flex flex-1 overflow-hidden pt-16 relative z-0">
        ...
        <div className="w-80 bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col fixed left-0 top-16 h-[calc(100vh-64px)] z-10 overflow-hidden" style={{ maxHeight: 'calc(100vh - 64px)' }}>
          {/* Header */}
          ...
          <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 space-y-2" style={{ scrollbarWidth: 'thin', scrollbarColor: 'rgba(107, 114, 128, 0.5) transparent', maxHeight: 'calc(100vh - 180px)', contain: 'layout style paint', position: 'relative', zIndex: 1 }}>
        ...
        <div className="flex-1 flex flex-col overflow-hidden pb-64 ml-80">
          {/* Scrollable Chat Area */}
          <div className="flex-1 overflow-y-auto px-5 py-2 min-h-0 max-h-[calc(100vh-230px)]">
            {messages.length === 0 ? (
          ...
          <div className="fixed bottom-0 left-0 right-0 p-4 bg-white dark:bg-gray-900 flex-shrink-0 z-20 ml-80" style={{ marginLeft: '320px' }}>
            {/* Attachments Display */}
            ...
            <div className="flex gap-3 items-end">
              <div className="flex-1 relative">
                ...
                <div className="absolute right-2 bottom-2 flex gap-1">
                  ...
                  >
                    <Globe className={`h-4 w-4 transition-all duration-200 ${isDeepResearch ? 'text-blue-600' : ''}`} />
              ...
              {isThinking ? (
                <Button
                  ...
                  className="bg-gray-700 hover:bg-gray-600 text-white h-12 w-12 rounded-full transition-colors duration-200 flex items-center justify-center"
                >
                ...
                <Button
                  ...
                  className="bg-gray-700 hover:bg-gray-600 text-white h-12 w-12 rounded-full disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center transition-colors duration-200"
                >
